...
function pindahHalaman(target) {
    const daftarHalaman = {
        ...
        'denah':          document.getElementById('halaman-denah'),
    ...
    const daftarTombol = {
        ...
        'denah':          document.getElementById('btn-nav-denah'),
    ...
    if (target === 'denah' && typeof initHalamanDenah === 'function') initHalamanDenah();
